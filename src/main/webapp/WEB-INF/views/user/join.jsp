         ...
         <div class="rq-form" >
             ...
             <div id="divid" class="box-input">
                <div class="input-wrap">
                   ...
                   <button class="Btn-1" type="button" onclick="checkEmailDuplication()">중복확인</button>
                </div>
                <div class="input-wrap">
             ...
             <button class="btns wid md-ripples ripples-light" type="button" onclick="signupFormSubmit()">회원가입</button>
              </form>
             </div>
         </div>
     </div>
