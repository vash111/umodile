 ...
 <body class="sb-nav-fixed">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="bg-white" name="frm" action="/notice/create" method="post" onsubmit="return clickSubmit()">
                        ...
                        <div class="row justify-content-md-center p-5 mb-3">
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <!-- 작성자 정보는 서버에서 처리하거나 세션에서 가져오기 -->
                                        <input type="text" class="form-control" name="writer" id="writer" readonly value="관리자">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2 text-center">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="10" name="content" id="editorTxt" class="form-control" placeholder="내용을 입력하세요" required></textarea>
                                    </div>
                                </div>
    ...
    function clickSubmit() {
        ...
        const content = document.getElementById("editorTxt").value.trim();
