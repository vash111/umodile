 ...
 <body class="sb-nav-fixed">
                        ...
                        <div class="row justify-content-md-center p-5 mb-3">
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" id="content" rows="10" readonly>${notice.content}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <button type="button" id="submitBtn" class="btn btn-warning btn-sm"
        										onclick="location.href='/admin/modify/${notice.nno}'">수정하기</button>
                                        <!-- 삭제 버튼 -->
                                        <button type="button" id="removeBtn" class="btn btn-danger btn-sm"
                                                onclick="deleteNotice(${notice.nno})">삭제하기</button>
                                        <!-- 목록 버튼 -->
    ...
    function deleteNotice(nno) {
        if (confirm("정말 삭제하시겠습니까?")) {
            fetch(`/admin/delete/${nno}`, {
                method: 'DELETE'
            })
            .then(response => {
                if (response.ok) {
                    alert("삭제되었습니다.");
                    location.href = "/admin/Adminmain"; // 목록 페이지로 이동
                } else {
                    alert("삭제에 실패했습니다.");
                }
            })
